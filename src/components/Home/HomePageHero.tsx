...
export default function HomePageHero(): JSX.Element {
  return (
    <>
      <div className="   mx-auto mt-20 w-full max-w-3xl flex-col flex items-center  text-center space-y-16 px-4 xl:flex-row xl:items-center xl:px-0 xl:max-w-6xl xl:justify-center xl:space-y-0 ">
